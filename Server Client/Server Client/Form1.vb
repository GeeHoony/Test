...
Public Class Form1
    Private Server As TcpListener 'CP 네트워크 클라이언트에서 연결 수신
    ...
    Private Sub 설정ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 설정ToolStripMenuItem.Click
    ...
    Private Sub 닫기ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 닫기ToolStripMenuItem.Click
        Me.Close()
    End Sub
    ...
    Private Sub tsbtnConn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnConn.Click
    ...
    Private Sub tsbtnDisconn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnDisconn.Click
        Try
            If (Me.cbServer.Checked) Then
                If (Me.SerClient.Connected) Then
                    Dim dt = Convert.ToString(DateTime.Now)
                    myWrite.WriteLine(Me.myName + "&" + "채팅 APP가 종료되었습니다." + "&" + dt)
                    myWrite.Flush()
                End If
            Else
    ...
    Private Sub txtMessage_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtMessage.KeyPress
        If (e.KeyChar = Chr(13)) Then '엔터 키를 누를때
    ...
    Private Sub Msg_send()
        Try
            Dim dt = Convert.ToString(DateTime.Now)
            myWrite.WriteLine(Me.myName + "&" + Me.txtMessage.Text + "&" + dt)
            myWrite.Flush()
    ...
    Private Sub cbServer_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbServer.CheckedChanged
        If (Me.cbServer.Checked) Then Me.txtIp.Enabled = False Else Me.txtIp.Enabled = True
    End Sub
End Class
